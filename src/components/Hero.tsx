        ...
        <section
              ...
              <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center">
                ...
                {/* Main headline */}
                      <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold tracking-tight leading-tight mb-6">
                                <span className="block text-foreground">Healthcare,</span>span>
                                <span className="block gradient-text">Redefined.</span>span>
                      </h1>h1>
          ...
          {/* Scroll indicator */}
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
                      <span className="text-xs text-muted">Scroll</span>span>
